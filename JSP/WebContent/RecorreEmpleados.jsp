...
<body>
	...
	<c:forEach var="empleado" items="${empleados}">
		...
		<tr>
			...
			<td> <c:if test="${empleado.salario<40000}">${empleado.salario+5000}</c:if>
			
			<c:if test="${empleado.salario>=40000}">${empleado.salario}</c:if>
			
			</td>
			
			<td><c:if test="${empleado.salario<40000}">5000</c:if>
			
			<c:if test="${empleado.salario>=40000}">NO</c:if>
