...
class LaminaBotones extends JPanel implements ActionListener {
	...
	public LaminaBotones() {
		...
		//botonAzul es el objeto fuente, al hacer clic se genera un objeto evento, this se refiere al objeto oyente, es decir la propia lámina
		...
		//Hay 4 objetos fuentes y un sólo oyente.
